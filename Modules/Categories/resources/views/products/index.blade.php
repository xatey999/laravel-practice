...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        @auth
            ...
            <a href="{{ route('admin.products.index') }}" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                Manage Products
            </a>
            @elseif(Auth::user()->role === \App\Enums\UserRoleEnum::SUPPLIER)
            <a href="{{ route('supplier.products.index') }}" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                My Products
            </a>
            @endif
        @endauth
